...
import 'package:flutter_musobaqa/provider/category_provider.dart';
import 'package:flutter_musobaqa/provider/products_provider.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provider/provider.dart';
import 'package:zoom_tap_animation/zoom_tap_animation.dart';

import 'package:flutter_musobaqa/ui/tab_user/product/product_detail_screen/product_detail_screen.dart';
...
class _ProductsUserScreenState extends State<ProductsUserScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Products Clinet"),
      ),
      body: Column(
        children: [
          SizedBox(
                  ...
                  if (snapshot.hasData) {
                    return snapshot.data!.isNotEmpty
                      ...
                      children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: 10.h,),
                                      Text(productModel.description,style: TextStyle(fontSize: 18.spMin,color: Colors.black,fontWeight: FontWeight.w500),),
                                      SizedBox(height: 10.h,),
                                      Text("Price: ${productModel.price} ${productModel.currency}",style: TextStyle(fontSize: 18.spMin,color: Colors.black,fontWeight: FontWeight.w500),),
                                      SizedBox(height: 10.h,),
                                      Text("Count: ${productModel.count}",style: TextStyle(fontSize: 18.spMin,color: Colors.black,fontWeight: FontWeight.w500),),
                                    ],
                                  ),
                                ],
                              ),
                        ...
                        :  Center(child: Text("Product Empty!",style: TextStyle(fontSize: 32.spMin,color: Colors.black,fontWeight: FontWeight.w700),));
                  }
                  if (snapshot.hasError) {
                    return Center(
                      child: Text(snapshot.error.toString()),
